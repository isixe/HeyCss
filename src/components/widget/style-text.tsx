...
export function StyleText({ index, style, tab }: StyleBoxProps) {
	...
	return (
		<div
			className={`group h-[40px] rounded-lg flex items-center justify-center font-medium transition-transform duration-200 hover:scale-105 relative cursor-pointer`}
			onClick={onStyleCopy}>
			<div className={`${uniqueClassName}`}>
				<span className="text-[16px] font-normal">Hey CSS </span>
				<span className="text-[16px] font-normal">#{index}</span>
