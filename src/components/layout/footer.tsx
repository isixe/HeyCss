				...
				<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
					<div className="col-span-1 md:col-span-2">
						<div className="flex items-center mb-4 gap-2">
							...
							<h2 className="text-2xl font-bold text-gray-900">HeyCSS</h2>
						</div>
					...
					<div>
						...
						<ul className="space-y-2">
							<li>
								<a href="mailto:isixe@outlook.com" className="text-gray-600 hover:text-gray-900 text-sm transition-colors cursor-pointer">
									Contact
								</a>
							</li>
							<li>
				...
				<div className="mt-8 pt-8 border-t border-gray-200">
					<div className="flex flex-col md:flex-row justify-between items-center">
						...
						<div className="flex space-x-4">
							...
							<a href="mailto:isixe@outlook.com" className="text-gray-400 hover:text-gray-600 transition-colors cursor-pointer">
